...
export default function RecoverUsername() {
  ...
  function onSubmit(e: React.FormEvent) {
    e.preventDefault();
    // Will be wired to backend: POST /auth/username/recover
    alert("Username recovery email will be sent (backend wiring next).");
  }
    ...
    <div className="authWrap">
      <div className="authCard glass-strong">
        ...
        <div className="authInlineCard">
          ...
          <Link className="authLinkStrong" to="/auth/forgot-password">
            Reset your password
          </Link>
        </div>
